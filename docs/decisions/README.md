...
| [011](011-ssh-hosts.md) | SSH hosts — relayLLM's half | Accepted |
| [012](012-endpoint-tls-pinning.md) | TLS pinning for the relayLLM-to-upstream endpoint hop | Accepted |
| [013](013-anthropic-messages-compat.md) | Anthropic Messages API compatibility on the relay-router | Accepted |

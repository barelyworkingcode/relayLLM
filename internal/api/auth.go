...
// socket is a machine client (relay's dispatcher, a direct socket client)
// that can just send a header.
//
...
// `Authorization: Bearer <token>` or it is rejected with HTTP 401 before
// any handler runs.
//
